...
const Home = () => {
    ...
    return (
      ...
      <div class="max-w-md mx-auto text-center pt-12">
            ...
            <p class="mt-4 text-base font-normal leading-7 text-gray-600">
            Choose from a wide range of effective Cars Near By Your Loaction.
            </p>
          </div>
                    <Category categories={categories} />
                    <Products
                        headingText="Popular Cars "
                        products={products}
                    />
                </div>
            </div>
